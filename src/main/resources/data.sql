...
INSERT INTO folder (name, tags, storage_id, parent_folder_id)
VALUES
    ...
    ('Subfolder 6', ARRAY['tag1', 'tag2'], 1, 1),
    ('Subfolder 7', ARRAY['tag1', 'tag2'], 1, 1);
...
VALUES
    ...
    ('Settings 5', ARRAY['tag1', 'tag2'], 'http://example.com/page1', 5, 'class1', 'tag1', '.next-page', ARRAY['Header1', 'Header2'], 1, 1),
    ('Settings 6', ARRAY['tag1', 'tag2'], 'http://example.com/page1', 5, 'class1', 'tag1', '.next-page', ARRAY['Header1', 'Header2'], 1, 1),
    ('Settings 7', ARRAY['tag1', 'tag2'], 'http://example.com/page1', 5, 'class1', 'tag1', '.next-page', ARRAY['Header1', 'Header2'], 1, 1);
